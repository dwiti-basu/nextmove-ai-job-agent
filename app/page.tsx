        ...
        {jobs.map(job => (
          <div key={job.job_id} className={`job-row fit-${job.fit_score || ''}`}>
            ...
            <div className="job-actions">
              ...
              <a className="btn btn-quiet" href={job.jd_link} target="_blank" rel="noreferrer" style={{ textDecoration: 'none', textAlign: 'center' }}>
                Apply on company site
              </a>
              <button className="btn btn-primary" onClick={() => generateCV(job.job_id)} disabled={generating === job.job_id}>
